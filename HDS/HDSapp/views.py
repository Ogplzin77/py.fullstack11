...
def home(request):
    return render(request, 'HDSapp/home.html')

def produtos(request):
    produtos = Produto.objects.filter(disponivel=True)
    return render(request, 'HDSapp/produtos.html', {'produtos': produtos})

def contatos(request):
    return render(request, 'HDSapp/contatos.html')
...
def add_produto(request):
    if request.method == 'POST':
        ...
        form = ProdutoForm()
    return render(request, 'HDSapp/add_produto.html', {'form': form})
...
def upload_profile(request):
    if request.method == 'POST':
        ...
        form = ProfileForm()
    return render(request, 'HDSapp/upload_profile.html', {'form': form})