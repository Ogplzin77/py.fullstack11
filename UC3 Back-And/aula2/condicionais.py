# Exemplo básico
nota = float(input("Digite sua nota (0-10): ")) # Entrada de dados

if nota >= 9: 
    conceito = "A" # Bloco de instruções
elif nota >= 7:
    conceito = "B"
elif nota >= 5:
    conceito = "C"
...
tem_ingresso = input("Tem ingresso? (s/n): ").lower() == 's' # Converte a resposta para minúscula e verifica se é igual a 's'
