class ContaBancaria:
    ...
    def __init__(self, numero, titular, saldo=0): #Método construtor __init__ para inicializar a conta com número, titular e saldo. 
        """Método especial __init__: inicializa o objeto."""
        self.numero = numero # Atributo da classe ContaBancaria que representa o número da conta. self representa a instância da classe ContaBancaria. 
